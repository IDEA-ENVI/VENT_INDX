--{
create or replace procedure vix_aggreg_vix (in_id_component in number)
as
begin
...
/
--}
grant execute on vix_aggreg_vix to vix_rw_role;
create or replace public synonym vix_aggreg_vix for vix_aggreg_vix;
--select to_char(current_date,'yyyy-mm-dd hh24:mi:ss') from dual;
--execute vix_aggreg_vix(1);
--select to_char(current_date,'yyyy-mm-dd hh24:mi:ss') from dual;
exit;